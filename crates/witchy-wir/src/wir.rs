...
impl VectorOp {
    pub fn wat(self) -> &'static str {
        match self {
            ...
            VectorOp::I32x4Eq => "i32x4.eq",
            VectorOp::I32x4Bitmask => "i32x4.bitmask",
            ...
            VectorOp::I64x2Sub => "i64x2.sub",
            VectorOp::I64x2Mul => "i64x2.mul",
            VectorOp::I32x4Add => "i32x4.add",
            VectorOp::I32x4Sub => "i32x4.sub",
            VectorOp::I32x4Mul => "i32x4.mul",
