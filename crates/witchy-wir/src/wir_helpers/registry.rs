...
pub fn wir_helper(name: &str) -> Option<WirHelperSpec> {
    match name {
        ...
        "dir_append_bytes" => Some(WirHelperSpec {
            func: host_void_helper_typed("dir_append_bytes", "dir_append_bytes", &[WirTy::Extern, WirTy::Str, WirTy::Str]),
            helper_deps: &[],
            import_deps: &["dir_append_bytes"],
            uses_heap: false,
            uses_table: false,
        }),
        ...
        "dict_find" => Some(WirHelperSpec {
            ...
            helper_deps: &["key_eq", "dict_hash", "dict_ctrl_h2", "dict_ctrl_h2_mask"],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
        }),
        "dict_slice_eq" => Some(WirHelperSpec {
            func: dict_slice_eq_helper(),
            helper_deps: &[],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
        }),
        "dict_hash_slice" => Some(WirHelperSpec {
            func: dict_hash_slice_helper(),
            helper_deps: &[],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
        ...
        "dict_find_slice" => Some(WirHelperSpec {
            ...
            helper_deps: &["dict_slice_eq", "dict_hash_slice", "dict_ctrl_h2", "dict_ctrl_h2_mask"],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
        }),
        "dict_get_slice_or" => Some(WirHelperSpec {
            func: dict_get_slice_or_helper(),
            helper_deps: &["dict_find_slice"],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
        }),
        "dict_contains_slice" => Some(WirHelperSpec {
            func: dict_contains_slice_helper(),
            helper_deps: &["dict_find_slice"],
            import_deps: &[],
            uses_heap: false,
            uses_table: false,
