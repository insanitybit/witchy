...
fn val_type(kind: Kind, gc_base: u32) -> ValType {
    match kind {
        ...
        Kind::AnyRef => ValType::Ref(RefType::new_abstract(AbstractHeapType::Any, true, false)),
...
fn encode_with_gc_source_map(
    ...
    for f in &module.funcs {
        crate::wir::collect_clos_signatures_seq(&f.body, &mut clos_signatures);
    }
...
fn vector_op_instr(op: VectorOp) -> Instruction<'static> {
    match op {
        ...
        VectorOp::I64x2Sub => Instruction::I64x2Sub,
        VectorOp::I64x2Mul => Instruction::I64x2Mul,
        VectorOp::I32x4Add => Instruction::I32x4Add,
        VectorOp::I32x4Sub => Instruction::I32x4Sub,
        VectorOp::I32x4Mul => Instruction::I32x4Mul,
