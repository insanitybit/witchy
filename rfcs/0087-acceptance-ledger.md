...
| 16 | **PROVEN** | The stable census records 25 entry-source `var` declarations, 469 resolved `var` calls, nine intentional expression-position auxiliary-result uses, 14 intentional statement-position auxiliary-result discards, and zero compiler rejections after RFC-0005 typed closure environments landed. |
