...
representation. During implementation, parsed `dyn` programs remained behind a
precise feature-stage diagnostic until the complete interpreter/Wasm runtime and
parity evidence could remove that gate together.
