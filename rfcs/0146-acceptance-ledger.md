...
| 1 awaited select fusion | partial infrastructure: 1B plus ready-path 1C slice; allocation-free 1D open | `/tmp/rfc0146-track1-1b-20260823.tsv`; fresh ready-path spot pair: candidate 19.18/19.50/18.91 ms, master 22.40/23.21/22.86 ms | WIR/carrier fusion test; ready-path WAT and semantic output evidence; no allocation-free counters yet | syntax fusion/deopt, WIR plan, carrier tests, select semantic output/parity passed | ready-path spot samples remain comparable to 1B; no promotion claim | `impl/rfc0146-track1-1cd`, 1B `a995eadc`, ready path pending commit | pending review; not Track 1 acceptance |
