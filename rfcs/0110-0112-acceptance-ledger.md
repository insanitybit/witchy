...
| 10 | **PARTIAL** | A codegen fixture runs a parser shell, iterator shell, borrowed token list, and traversal through compiled Wasm with root retain/release structure. An interpreter differential fixture and deterministic zero-materialization counters remain required. |
