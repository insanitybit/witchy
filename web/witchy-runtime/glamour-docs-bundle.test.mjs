...
`);
  ...
  ok(manifest.routes.length === 62, "the book publishes all 62 canonical routes");
  ok(manifest.contentInputs.length === 62, "the build authenticates all 62 Markdown inputs");
  ok(
