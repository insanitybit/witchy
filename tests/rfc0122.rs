...
fn reference_return_telemetry_corpus_pins_schema_and_copy_parity() {
    ...
    assert!(EXPECTED.contains("optimized.metrics=1,1,1,1,2,0,812,0,0,0,0"));
    assert!(EXPECTED.contains("forced_copy.metrics=1,1,1,1,2,0,812,0,0,0,0"));
}
